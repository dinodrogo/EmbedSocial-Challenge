...
<body>
    ...
    <form action="main.php" method="post">
        Order by rating:
        <br>
        <select name="HighLowFirst" style="width: 200px;">  
        ...
        Minimum rating
        <br>
        <select name="MinRating" style="width: 200px;">
        ...
        Order by date:
        <br>
        <select name="DateOrder" style="width: 200px;">    
        ...
        Prioritize by text:
        <br>
        <select name="TextPrio" style="width: 200px;"> 
    ...
    function Filter($reviews){
        ...
        if($_POST['DateOrder']=='NewestFirst'){
            for($i=0; $i<count($reviews); $i++){
                for($j=0; $j<count($reviews)-1; $j++){
        ...
        if($_POST['TextPrio']=='TextPrioYes'){
            ...
            for($i=0; $i<count($textArr); $i++){
                echo '<tr>';
                if($textArr[$i]['rating']>=$_POST['MinRating']){
            ...
            for($i=0; $i<count($noTextArr); $i++){
                echo '<tr>';
                if($noTextArr[$i]['rating']>=$_POST['MinRating']){
            ...
            for($i=0; $i<count($reviews); $i++){
                echo '<tr>';
                if($reviews[$i]['rating']>=$_POST['MinRating']){
